...
describe('SignalBuilder - SSR Compatibility', () => {
    ...
    describe('Edge Cases', () => {
        it('should handle null initial values', () => {
            const signal: SignalPlus<string | null> = new SignalBuilder<string | null>(null)
        ...
        it('should handle undefined in arrays', () => {
            const signal: SignalPlus<(number | undefined)[]> = new SignalBuilder<(number | undefined)[]>([1, undefined, 3])
