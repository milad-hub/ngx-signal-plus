...
describe('Signal Creation Utils', () => {
  ...
  describe('sp function', () => {
    ...
    it('should support persistence', fakeAsync(() => {
      const signal: SignalPlus<string> = sp('test').persist('test-key').build();
    ...
    it('should support history', () => {
      const signal: SignalPlus<number> = sp(0).withHistory(true).build();
      signal.setValue(1);
      signal.setValue(2);
      signal.undo();
  ...
  describe('spCounter', () => {
    ...
    it('should throw RangeError for invalid min > max combinations', () => {
      ...
      expect(() => spCounter(0, { min: 10, max: 0 })).toThrowError(
  ...
  describe('createSimple', () => {
    ...
    it('should support persistence with key', fakeAsync(() => {
      const toggle: SignalPlus<boolean> = createSimple(
        false,
        'test-create-simple',
      );
      expect(toggle.value).toBe(false);
    ...
    it('should throw TypeError for non-boolean string', () => {
      ...
      expect(() => createSimple('not a boolean' as any)).toThrowError(
        TypeError,
      );
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      expect(() => createSimple('not a boolean' as any)).toThrowError(
        /createSimple: initial value must be boolean, got string/,
      );
    });
    ...
    it('should throw TypeError for non-boolean number', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      expect(() => createSimple(0 as any)).toThrowError(
        /createSimple: initial value must be boolean, got number/,
      );
    });
    ...
    it('should throw TypeError for null', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      expect(() => createSimple(null as any)).toThrowError(
        /createSimple: initial value must be boolean, got object/,
      );
    });
    ...
    it('should throw TypeError for undefined', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      expect(() => createSimple(undefined as any)).toThrowError(
        /createSimple: initial value must be boolean, got undefined/,
      );
    });
    ...
    it('should throw TypeError for array', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      expect(() => createSimple([] as any)).toThrowError(
        /createSimple: initial value must be boolean, got object/,
      );
    });
  ...
  describe('spForm', () => {
    describe('text input', () => {
      ...
      it('should throw RangeError for invalid minLength > maxLength combinations', () => {
        expect(() =>
          spForm.text('', { minLength: 10, maxLength: 5 }),
      ...
      it('should throw RangeError for negative debounce values', () => {
        expect(() => spForm.text('', { debounce: -100 })).toThrowError(
          RangeError,
        );
        expect(() => spForm.text('', { debounce: -100 })).toThrowError(
          /debounce \(-100\) cannot be negative/,
        );
      });
    });
    ...
    describe('email input', () => {
      ...
      it('should throw RangeError for negative debounce values', () => {
        expect(() => spForm.email('', { debounce: -200 })).toThrowError(
          RangeError,
        );
        expect(() => spForm.email('', { debounce: -200 })).toThrowError(
          /debounce \(-200\) cannot be negative/,
        );
      });
    });
    ...
    describe('number input', () => {
      ...
      it('should throw RangeError for invalid min > max combinations', () => {
        expect(() => spForm.number({ min: 10, max: 0 })).toThrowError(
          RangeError,
        );
        expect(() => spForm.number({ min: 10, max: 0 })).toThrowError(
          /min \(10\) cannot be greater than max \(0\)/,
      ...
      it('should throw RangeError for negative debounce values', () => {
        expect(() => spForm.number({ debounce: -300 })).toThrowError(
          RangeError,
        );
        expect(() => spForm.number({ debounce: -300 })).toThrowError(
          /debounce \(-300\) cannot be negative/,
        );
      });
      ...
      it('should handle transform edge cases', () => {
        ...
        try {
          ...
          // Expected error - testing type conversion
        }
        expect(form.value).toBe(0);
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  describe('edge cases', () => {
    it('should handle circular references', () => {
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const signal: SignalPlus<any> = sp({ value: 0 })
        .persist('circular-test')
        .build();
    ...
    it('should handle subscription cleanup', () => {
      const signal: SignalPlus<number> = sp(0).build();
      const values: number[] = [];
      const cleanup: () => void = signal.subscribe((value) =>
        values.push(value),
      );
      cleanup();
      signal.setValue(1);
