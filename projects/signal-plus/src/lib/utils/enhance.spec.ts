...
describe('enhance', () => {
  ...
  describe('creation and initialization', () => {
    ...
    it('should handle undefined signal values', () => {
      const testSignal: WritableSignal<undefined> =
        angularSignal<undefined>(undefined);
  ...
  describe('feature integration', () => {
    ...
    describe('persistence', () => {
      it('should support persistence configuration', () => {
        ...
        const result: SignalPlus<string> = enhance(testSignal)
          .persist(storageKey)
          .build();
      ...
      it('should persist value changes to localStorage', () => {
        ...
        const result: SignalPlus<string> = enhance(angularSignal(initialValue))
          .persist(storageKey)
          .build();
      ...
      it('should load persisted values on initialization', () => {
        ...
        const result: SignalPlus<string> = enhance(angularSignal(''))
          .persist(storageKey)
          .build();
    ...
    describe('validation', () => {
      it('should support validation configuration', () => {
        ...
        const validator: (value: number) => boolean = (value: number) =>
          value > 0;
        const result: SignalPlus<number> = enhance(testSignal)
          .validate(validator)
          .build();
      ...
      it('should support multiple validators', () => {
        const testSignal: WritableSignal<number> = angularSignal(5);
        const validator1: (value: number) => boolean = (value: number) =>
          value > 0;
        const validator2: (value: number) => boolean = (value: number) =>
          value < 10;
        const result: SignalPlus<number> = enhance(testSignal)
          .validate(validator1)
          .validate(validator2)
  ...
  describe('type safety', () => {
    ...
    it('should maintain type safety with complex objects', () => {
      ...
      const result: SignalPlus<TestType> = enhance(
        angularSignal<TestType>(initialValue),
      )
        .validate((v) => v.id > 0)
        .build();
    ...
    it('should handle array types', () => {
      const result: SignalPlus<number[]> = enhance(
        angularSignal<number[]>([1, 2, 3]),
      )
    ...
    it('should handle generic type constraints', () => {
      ...
      const extendedSignal: WritableSignal<Extended> = angularSignal<Extended>({
        id: 1,
        value: 'test',
      });
  ...
  describe('event handling', () => {
    it('should notify subscribers of value changes', () => {
      const result: SignalPlus<number> = enhance(angularSignal(5)).build();
      const values: number[] = [];
    ...
    it('should handle multiple subscribers correctly', () => {
      ...
      const unSubscribe1: () => void = result.subscribe((value) =>
        changes1.push(value),
      );
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      const unSubscribe2: () => void = result.subscribe((value) =>
        changes2.push(value),
      );
      result.setValue(1);
      unSubscribe1();
...
describe('enhance - advanced scenarios', () => {
  ...
  describe('history management', () => {
    ...
    it('should handle custom history serialization', () => {
      ...
      const testSignal: SignalPlus<ComplexType> = enhance(
        angularSignal<ComplexType>({
          id: 1,
          data: 'test',
          timestamp: new Date(),
        }),
  ...
  describe('performance optimizations', () => {
    it('should handle large datasets efficiently', () => {
      ...
      const testSignal: SignalPlus<number[]> = enhance(
        angularSignal<number[]>(largeArray),
      ).build();
  ...
  describe('type system edge cases', () => {
    it('should handle union types correctly', () => {
      ...
      const testSignal: SignalPlus<UnionType> = enhance(
        angularSignal<UnionType>('test'),
      )
        .transform((value) =>
    ...
    it('should handle readonly types', () => {
      ...
      const testSignal: SignalPlus<ReadonlyType> = enhance(
        angularSignal<ReadonlyType>({ id: 1, value: 'test' }),
      )
    ...
    it('should preserve signal type information', () => {
      ...
      const original: WritableSignal<User> = angularSignal<User>({
        id: 1,
        name: 'test',
      });
      ...
      // @ts-expect-error - Testing type safety, intentionally wrong type
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  describe('error recovery', () => {
    ...
    it('should handle error event bubbling', () => {
      ...
      try {
        ...
        // Expected error - testing error event bubbling
      }
  ...
  describe('framework integration', () => {
    it('should work with Angular change detection', fakeAsync(() => {
      const testSignal: SignalPlus<number> = enhance(angularSignal(0))
        ...
        .build();
      let updateCount = 0;
      const subscription: () => void = testSignal.subscribe(
        () => updateCount++,
      );
      testSignal.setValue(1);
      tick(50);
