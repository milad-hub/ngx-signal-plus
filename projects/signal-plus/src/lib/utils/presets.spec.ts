...
describe('Presets', () => {
  ...
  describe('counter preset', () => {
    ...
    it('should create counter with custom initial value', () => {
      const counter: SignalPlus<number> = presets
        .counter({ initial: 5 })
        .build();
  ...
  describe('form input preset', () => {
    it('should create basic form input', () => {
      const input: SignalPlus<string> = presets
        .formInput({ initial: '' })
        .build();
  ...
  describe('persistent toggle preset', () => {
    it('should create persistent toggle with default value', () => {
      const toggle: SignalPlus<boolean> = presets
        .persistentToggle(false, 'test-toggle')
        .build();
      expect(toggle.value).toBe(false);
      expect(toggle.initialValue).toBe(false);
    });
    ...
    it('should handle storage errors in persistent toggle', fakeAsync(() => {
      ...
      const toggle: SignalPlus<boolean> = presets
        .persistentToggle(true, 'test-toggle')
        .build();
      expect(() => {
        toggle.setValue(false);
        tick();
  ...
  describe('resource management', () => {
    it('should properly cleanup subscriptions', fakeAsync(() => {
      const input: SignalPlus<string> = presets
        ...
        .build();
      const values: string[] = [];
      const unSubscribe: () => void = input.subscribe((value) =>
        values.push(value),
      );
    ...
    it('should handle multiple subscribers correctly', fakeAsync(() => {
      ...
      const unSub1: () => void = input.subscribe((value) =>
        values1.push(value),
      );
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      const unSub2: () => void = input.subscribe((value) =>
        values2.push(value),
      );
  ...
  describe('type safety', () => {
    ...
    it('should handle complex object structures', fakeAsync(() => {
      ...
      const input: SignalPlus<ComplexType> = presets
        .formInput<ComplexType>({
          initial,
          key: 'complex-object',
        })
        .build();
  ...
  describe('edge cases', () => {
    it('should handle null/undefined values correctly', fakeAsync(() => {
      const input: SignalPlus<string | null | undefined> = presets
    ...
    it('should handle undefined in complex objects', () => {
      ...
      const input: SignalPlus<PartialType> = presets
        .formInput<PartialType>({
  ...
  describe('form input preset - comprehensive', () => {
    describe('value type handling', () => {
      ...
      it('should handle number inputs', () => {
        const input: SignalPlus<number> = presets
          .formInput<number>({
            initial: 0,
      ...
      it('should handle object inputs', () => {
        ...
        const input: SignalPlus<TestObject> = presets
          .formInput<TestObject>({
  ...
  describe('validators - comprehensive', () => {
    describe('number validators', () => {
      ...
      it('should validate ranges', () => {
        const range: (value: number) => boolean = validators.number.range(
          0,
          10,
        );
    ...
    describe('string validators', () => {
      ...
      it('should validate max length', () => {
        const maxLength: (value: string) => boolean =
      ...
      it('should validate patterns', () => {
        const emailPattern: (value: string) => boolean =
          validators.string.pattern(/^[\w-.]+@([\w-]+\.)+[\w-]{2,4}$/);
